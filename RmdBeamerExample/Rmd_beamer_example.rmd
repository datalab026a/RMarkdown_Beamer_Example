...
output: 
  beamer_presentation:
    keep_tex: true
    slide_level: 3
    highlight: zenburn # tango
    pandoc_args: "--latex-engine=xelatex"
    includes:
      in_header: ./texFiles/beamer_header.tex
      before_body: ./texFiles/beamer_prefix.tex
      after_body: ./texFiles/beamer_suffix.tex
    template: ./texFiles/beamer_default.tex
---
...
* 参考资料
    ...
    5. [LaTeX Templates - Keynote-style Gradient template for Beamer](http://www.ucl.ac.uk/~ucbpeal/latexposter.html)
...
* kniter+ pandoc
![](./figureFiles/knitr-workflow.png)
